...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_TO_LED]     = ACTION_TAP_DANCE_DUAL_ROLE(KC_WWW_HOME, _CONTROL),
    [TD_TO_DEFAULT] = ACTION_TAP_DANCE_DUAL_ROLE(KC_WWW_HOME, _BASE)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_CONTROL] = LAYOUT( /* LED Control */
          KC_NO,            KC_NO,
    _______, RGB_MODE_FORWARD, RGB_MODE_REVERSE, TD(TD_TO_DEFAULT),
    RGB_VAD, RGB_VAI, RGB_HUD,  RGB_HUI,
    RGB_SAD, RGB_SAI, _______,  _______,
    _______, _______, RESET,    RGB_TOG
  ),
};
